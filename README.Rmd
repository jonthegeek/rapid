...
Convert an API document (APID), such as one that follows the [OpenAPI Specification](https://spec.openapis.org/oas/v3.0.0), to an R API definition object.
The R object belongs to a new S3 class, "apid", which enforces a strict, opinionated schema.
